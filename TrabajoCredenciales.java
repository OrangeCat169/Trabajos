        ...
        do {
            ...
            switch (opcion) {
                ...
                case 3:
                    ...
                    registro.personalizar("Credencial de Registro", "Teléfono de Contacto");

                    Credenciales2 encuesta = base.clone();
                    encuesta.personalizar("Credencial de Encuesta", "Edad del Asistente");
