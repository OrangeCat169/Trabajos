...
Reforzar la seguridad mediante aislamiento de componentes críticos.

Aumentar la escalabilidad, permitiendo escalar servicios específicos según demanda.

Mejorar la disponibilidad, asegurando que fallos en un nodo no afecten a toda la solución.
...
REST: Utilizado en la mayoría de las APIs internas y externas por su simplicidad y compatibilidad con HTTP.

SOAP: Utilizado en integraciones heredadas con sistemas ERP que requieren contratos estrictos y seguridad WS-*.
